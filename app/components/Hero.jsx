...
const Hero = () => {
    return (
        <section className="flex flex-col md:flex-row items-center md:items-start justify-center text-left py-10 px-6 md:px-20">
            ...
            <motion.div
                ...
                className="w-36 h-36 md:w-44 md:h-44 rounded-full overflow-hidden border-4 border-gray-300 shadow-lg"
            >
                <Image
            ...
            >
                {/* Nombre y título */}
                <h1 className="text-4xl font-bold text-gray-900">Eleazar García</h1>
                <p className="text-lg text-blue-600 font-semibold mt-2">
                    Desarrollador de Software
                </p>

                {/* Descripción */}
                <p className="text-gray-600 text-sm mt-4 leading-relaxed max-w-lg">
